...
import { TicketPercent, Image, Megaphone } from "lucide-react";

const tabs = [
    { label: "Discounts & Coupons", href: "/app/marketing/coupons", icon: TicketPercent },
    { label: "Banners", href: "/app/marketing/banners", icon: Image },
